...
public class ViewSupInvoice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("View Supplier Invoice | JRTraders");
        ...
        TxtStartDate.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        ...
        txtEndDate.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill No", "Invoice Date", "Invoice Total", "Discount", "Nett Total", "Customer"
            }
        ));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(radioFilter, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(comboSupllier, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addComponent(txtEndDate, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
                                .addGap(20, 20, 20)
...
//                        GRNPIC.put(inv.getGrnno(), inv.getPhoto());
                        dtm.addRow(new Object[]{
                            ...
                            inv.getSupplier().getSupplierName()
...
//                        GRNPIC.put(inv.getGrnno(), inv.getPhoto());
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        try {
            ...
            Session openSession = PoolManager.getSessionFactory().openSession();
            Criteria cc = openSession.createCriteria(SupplierInvoice.class);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        if (showConfirmDialog == 0) {
            ...
            try {
                ...
                SupplierInvoice uniqueResult = (SupplierInvoice) createCriteria.uniqueResult();

                uniqueResult.setIsActive("DeActive");
                openSession.update(uniqueResult);

                Iterator iterator = uniqueResult.getSupplierInvoiceItems().iterator();
                while (iterator.hasNext()) {
                    ...
                    Iterator it = next.getSupplierInvoiceItemHasItemSereals().iterator();
                    while (it.hasNext()) {
                        SupplierInvoiceItemHasItemSereal next1 = (SupplierInvoiceItemHasItemSereal) it.next();
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ViewSupInvoice.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if (FLAG) {
            ...
            try {
                Map<String, Object> map = new HashMap<String, Object>();
                map.put("InvoiceNO", jTable1.getValueAt(jTable1.getSelectedRow(), 0));
                JasperPrint jasperPrint = JasperFillManager.fillReport(Login.jrSupInvoiceWithSerial, map, DB.getCon());
            ...
            try {
                Map<String, Object> map = new HashMap<String, Object>();
                map.put("InvoiceNO", jTable1.getValueAt(jTable1.getSelectedRow(), 0));
                JasperPrint jasperPrint = JasperFillManager.fillReport(Login.jrSupInvoice, map, DB.getCon());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSupInvoice().setVisible(true);
            }
        });
    }
